...
if __name__=='__main__':
  ...
  laser = rospy.Subscriber('/uvbot/laser/scan', LaserScan, callback) # laser is a subscriiber object which listens to /uvbot/laser/scan topic and it will call the function callback each time
  ...
  scan_pub = rospy.Publisher('uvbot_laser_scan', LaserScan, queue_size=1)
  rospy.spin()
