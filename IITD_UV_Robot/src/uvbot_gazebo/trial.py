...
if __name__=='__main__':
  ...
  laser = rospy.Subscriber('/uvbot/laser/scan', LaserScan, callback) # laser is a subscriiber object which listens to /mybot/laser/scan topic and it will call the function callback each time
