...
def callback(sub,sub5):
    ...
    while not rospy.is_shutdown():
      ...
      scan_pub = rospy.Publisher('uvbot_laser_scan', LaserScan, queue_size=0)# my_laser_scan is my topic
...
sub = message_filters.Subscriber('/uvbot/laser/scan', LaserScan)# laser scan from where I subscribe
